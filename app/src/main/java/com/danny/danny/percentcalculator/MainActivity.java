package com.danny.danny.percentcalculator;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        percentageText = (EditText) findViewById(R.id.percent_text_view);
        numberText = (EditText) findViewById(R.id.number_text_view);
